...
README and website download buttons open GitHub's `/releases/latest` page
(generated by `packaging/update-public-downloads.ps1`). It always resolves to the
newest release marked Latest and skips pre-releases, so promoting a release
