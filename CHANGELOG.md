...
Internal 0.7.8-0.7.43 implementation labels were never published releases; their work is consolidated here.
...
- Native wired DualSense overlay results are owner-provided physical evidence; preset/capture and unnamed game cases are not inferred.
- DSX switching remains partial pending a focused retest. The abnormal-kill test was not run and was explicitly skipped by the owner with residual risk accepted.
