# GameHQ 0.7.31 (2026-09-14)

## Fixed

- Added an optional GitHub link beneath upcoming release notes to open the same release in your browser, with controller navigation support.

<!-- gamehq:locale-index -->

## Release notes in other languages

These release notes are published in English by default. [Release notes in 16 languages](https://github.com/underfusion/GameHQ/tree/v0.7.31/assets/release-notes/publication/0.7.31) are kept in the repository; they are not attached to this release as separate downloads.
