# GameHQ 0.7.20 (2026-09-09)

## Added

- Capture sounds now have their own volume in Settings, separate from the interface volume, and a preview button that plays the real capture sound so the level can be set without taking a screenshot.

<!-- gamehq:locale-index -->

## Release notes in other languages

These release notes are published in English by default. [Release notes in 16 languages](https://github.com/underfusion/GameHQ/tree/v0.7.20/assets/release-notes/publication/0.7.20) are kept in the repository; they are not attached to this release as separate downloads.
