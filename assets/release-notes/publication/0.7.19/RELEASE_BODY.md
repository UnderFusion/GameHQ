# GameHQ 0.7.19 (2026-09-09)

## Fixed

- Every skipped or failed screenshot and every failed clip save now shows a clear notification stating the reason. When a capture file is written but cannot be added to the library, the notification says "Saved to disk, not in library" instead of claiming it was saved.

<!-- gamehq:locale-index -->

## Release notes in other languages

These release notes are published in English by default. [Release notes in 16 languages](https://github.com/underfusion/GameHQ/tree/v0.7.19/assets/release-notes/publication/0.7.19) are kept in the repository; they are not attached to this release as separate downloads.
