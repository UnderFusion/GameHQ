# GameHQ 0.7.29 (2026-09-14)

## Fixed

- Suggested updates show matching bundled release notes when available, or a direct link to the GitHub release notes instead of an empty panel.

<!-- gamehq:locale-index -->

## Release notes in other languages

These release notes are published in English by default. [Release notes in 16 languages](https://github.com/underfusion/GameHQ/tree/v0.7.29/assets/release-notes/publication/0.7.29) are kept in the repository; they are not attached to this release as separate downloads.
