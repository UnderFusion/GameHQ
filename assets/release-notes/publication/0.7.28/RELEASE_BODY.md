# GameHQ 0.7.28 (2026-09-12)

## Fixed

- Fixed the blank main window after introducing interface scaling. Backgrounds stay behind controls, and action menus stay above content in both windows.

<!-- gamehq:locale-index -->

## Release notes in other languages

These release notes are published in English by default. [Release notes in 16 languages](https://github.com/underfusion/GameHQ/tree/v0.7.28/assets/release-notes/publication/0.7.28) are kept in the repository; they are not attached to this release as separate downloads.
