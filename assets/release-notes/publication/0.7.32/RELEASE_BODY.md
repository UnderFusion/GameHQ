# GameHQ 0.7.32 (2026-09-14)

## Fixed

- Previously discovered updates and their cached release notes remain available after restarting GameHQ offline. Cached discovery never replaces update signature verification.

<!-- gamehq:locale-index -->

## Release notes in other languages

These release notes are published in English by default. [Release notes in 16 languages](https://github.com/underfusion/GameHQ/tree/v0.7.32/assets/release-notes/publication/0.7.32) are kept in the repository; they are not attached to this release as separate downloads.
